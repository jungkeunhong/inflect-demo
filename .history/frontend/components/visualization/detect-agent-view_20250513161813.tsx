                  ...
                  <div className="h-[240px] w-full relative bg-gray-50 rounded-md p-4">
                    ...
                    <div className="absolute left-8 right-4 top-0 bottom-8 flex items-end">
                      ...
                      <svg className="w-full h-full overflow-visible">
                        {/* Baseline area */}
                        <path 
                          d="M0,160 L103,160 L206,160 L309,160 L412,160 L515,160 L618,160 L618,200 L0,200 Z" 
                          fill="#f5f5f5" 
                          strokeWidth="2"
                          stroke="#e0e0e0"
                        />
                        ...
                        {/* Anomaly score area */}
                        <path 
                          d="M0,150 L103,160 L206,140 L309,120 L412,80 L515,110 L618,50 L618,200 L0,200 Z" 
                          fill="#93c5fd" 
                          strokeWidth="2"
                          stroke="#3b82f6"
                        />
                        ...
                        {/* Data points */}
                        <circle cx="0" cy="150" r="4" fill="white" stroke="#3b82f6" strokeWidth="2" />
                        ...
                        <circle cx="412" cy="80" r="4" fill="white" stroke="#3b82f6" strokeWidth="2" />
                        <circle cx="515" cy="110" r="4" fill="white" stroke="#3b82f6" strokeWidth="2" />
                        <circle cx="618" cy="50" r="4" fill="white" stroke="#3b82f6" strokeWidth="2" />
                      </svg>
                    </div>
