...
export const mockAgents: Agent[] = [
  ...
  },
  {
    id: "agent-2",
    name: "Detect Agent",
    description: "I scan your customer activity and spot unusual patterns before they churn. Think: silent users, drop-offs, or sudden behavior shifts.",
    tools: ["anomaly", "churn-detection"],
    status: "idle",
    createdAt: new Date(),
    updatedAt: new Date()
  },
  {
    id: "agent-3",
    name: "Plan Agent",
    description: "Auto-generates win-back flows: free trials, reactivation emails, or Slack alerts—customized by segment.",
    tools: ["Google Docs"],
    status: "idle",
    createdAt: new Date(),
    updatedAt: new Date()
  },
  {
    id: "agent-4",
    name: "Act Agent",
    description: "Executes across channels. Sends offers via email, notifies CSMs in Slack, or triggers Retool dashboards.",
    tools: ["Google Docs"],
    status: "idle",
    createdAt: new Date(),
    updatedAt: new Date()
...
export const demoConversationSteps: Array<() => Omit<Message, 'id' | 'createdAt'>> = [
  ...
  () => ({ // Step 4: Agent design complete (simulated)
    role: "assistant",
    content: "I've designed the agent flow. Here's a visualization. You can now test it."
