    ...
    >
      <Card className="w-full bg-white rounded-lg shadow-sm border-0">
        ...
        <CardContent className="space-y-8 pt-2">
          ...
          <div>
            <h3 className="text-lg font-semibold mb-4 text-gray-800">Summary: Detected behavior</h3>
          ...
          <div>
            <h3 className="text-lg font-semibold mb-4 text-gray-800">Churn risk preview</h3>
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
              {/* Simplified Chart (static visualization instead of Recharts) */}
              <Card className="border border-gray-100">
                <CardHeader className="pb-2">
                  <CardTitle className="text-md">Anomaly Trend</CardTitle>
